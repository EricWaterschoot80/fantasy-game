...
const GAME = {
  ...
  scenes: {
    ...
    garden: {
      ...
      worldItems: [],
      npcs: [
        { id: 'princess', sprite: 'princess', idleFrames: 'princess-idle', idleLoop: true, idleStepMs: 130, x: 424, y: 250, scale: 0.9 }   // mooiere prinses, 3/4-hoek, 10 flutter-frames: lichaam stil, haar + jurk wapperen
      ],
      fx: {},
      hotspots: [
        {
