...
const GAME = {
  ...
  scenes: {
    ...
    garden: {
      ...
      worldItems: [],
      npcs: [
        { id: 'princess', sprite: 'princess', idleFrames: 'princess-idle', idleLoop: true, idleStepMs: 190, x: 424, y: 250, scale: 0.9 }   // prinses staat stil; alleen haar + jurk wapperen (flutter-frames)
      ],
      fx: {},
      hotspots: [
        {
