...
const GAME = {
  ...
  scenes: {
    ...
    courtyard: {
      ...
      worldItems: [],
      npcs: [
        { id: 'squire', sprite: 'squire', idleBreathe: true, sway: true, filter: 'brightness(0.78) saturate(0.92)', x: 486, y: 284, scale: 1.18, flip: true }   // schildknaap iets groter; vloeiende procedurele idle (ademen + zachte schommel) — geen frame-spook/geknipper
      ],
      fx: {},
      hotspots: [
        {
        ...
        },
        {
          ...
          walkTo: { x: 72, y: 252 },
          hideFlag: 'tookHammer',                          // verdwijnt als interactie zodra de hamer weg is (blijft als sfeer)
          gives: {
            item: 'hammer',
            setFlag: 'tookHammer',
            giveText: { nl: 'Onder het afdakje gloeit het smidsvuur na. Tang en hamer liggen klaar, maar de smid is nergens te bekennen. Je pakt de zware smidshamer mee.', en: 'Under the lean-to the forge fire still glows. Tongs and hammer lie ready, but the smith is nowhere to be seen. You take the heavy blacksmith’s hammer.' },
    ...
    garden: {
      ...
      worldItems: [],
      npcs: [
        { id: 'princess', sprite: 'princess', idleBreathe: true, sway: true, filter: 'brightness(0.78) saturate(0.92)', flip: true, x: 424, y: 250, scale: 1.14 }   // prinses iets donkerder; vloeiende procedurele idle (ademen + zachte schommel) — geen frame-spook/geknipper
      ],
      fx: {},
      hotspots: [
        {
